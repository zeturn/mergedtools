  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid md:grid-cols-2 gap-3 items-center">
        <Input  variant="simple" className="" value={name} onChange={(e) => setName(e.target.value)} placeholder="v5 name" />
        <Input  variant="simple" className="" value={ns} onChange={(e) => setNs(e.target.value)} placeholder="v5 namespace UUID" />
      </div>
    </div>
  )
}
